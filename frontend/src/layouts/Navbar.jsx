      ...
      <ul className="navbar__links md:flex items-start gap-5 font-medium ">
        {navbar_links.map((link) => (
          ...
          >
            ...
            <hr className="navbar__hr border-none outline-none h-0.5 bg-green-200 w-3/5 m-auto opacity-0" />
          </NavLink>
        ))}
      </ul>
      <div className="navbar__button-container flex items-center gap-4">
        {token ? (
          <div className="w-39 flex items-center justify-end gap-2 cursor-pointer group relative">
            <img
