  ...
  return (
    <footer className="footer w-full mt-24 px-4 py-8 flex flex-col">
      <div className="footer-container w-full max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-8">
        ...
        <div className="footer-info w-full flex flex-col gap-6 sm:flex-row justify-between items-start sm:pl-[10vw] sm:gap-12 md:w-1/2 md:pt-2 md:gap-6 lg:gap-12">
          ...
          <div className="footer__contacts w-full ">
            ...
            <address className="footer__contacts-container not-italic">
              <ContactData
                phone={footer_data.contacts.phone}
                email={footer_data.contacts.email}
                margin={"mb-2"}
              />
            </address>
          </div>
      ...
      <div className="footer__copyright w-full text-center mt-16 pt-4 flex flex-col sm:mt-8 sm:flex-row justify-center items-center border-t border-t-gray-400">
