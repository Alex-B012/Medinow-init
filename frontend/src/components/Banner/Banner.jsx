...
const Banner = ({ banner_data }) => {
  return (
    <div className="header w-full max-w-300 h-full  bg-primary text-white p-2 mt-8 flex flex-col justify-between gap-4 rounded-lg md:min-h-87 md:flex-row md:justify-center lg:min-h-100 lg:p-4 xl:min-h-90 2xl:max-h-90">
